    ...
    <Grid>
        ...
        <Border Grid.Row="0" Background="#1a1a2e" BorderBrush="#00d4ff" BorderThickness="0,0,0,1">
            <Grid>
                <StackPanel Orientation="Horizontal" VerticalAlignment="Center" Margin="20,0">
                    <TextBlock Text="[S]" FontSize="22" Foreground="#00d4ff" VerticalAlignment="Center" Margin="0,0,10,0" FontWeight="Bold"/>
                    <StackPanel VerticalAlignment="Center">
                        <TextBlock Text="SUPREME OPTIMIZATION" FontSize="20" FontWeight="Bold" Foreground="#00d4ff" FontFamily="Consolas"/>
                        <TextBlock Text="supreme-optimization.netlify.app" FontSize="11" Foreground="#666666" FontFamily="Consolas"/>
                    </StackPanel>
                </StackPanel>
        ...
        <Grid x:Name="LoginGrid" Grid.Row="1" Background="#0d0d0d">
            <StackPanel VerticalAlignment="Center" HorizontalAlignment="Center" Width="420">
                ...
                <Border Background="#1a1a2e" BorderBrush="#00d4ff" BorderThickness="1" CornerRadius="6" Padding="20">
                    <StackPanel>
                        ...
                        <TextBlock x:Name="StatusMsg" Text="" FontFamily="Consolas"
                                   FontSize="12" Margin="0,12,0,0" HorizontalAlignment="Center"/>
                        <Button x:Name="BtnValidar" Content="VALIDAR KEY"
                                Style="{StaticResource SupremeBtn}"
                                Height="42" Margin="0,15,0,0" FontSize="14" FontWeight="Bold"/>
                        <TextBlock Text="Nao tem uma key? Acesse supreme-optimization.netlify.app"
        ...
        <Grid x:Name="MainGrid" Grid.Row="1" Background="#0d0d0d" Visibility="Collapsed">
            <TabControl Background="#0d0d0d" BorderThickness="0" Margin="10">
                <TabItem Header="Otimizacoes">
                    <ScrollViewer VerticalScrollBarVisibility="Auto" Background="#0d0d0d">
                        <StackPanel Margin="20">
                            <TextBlock Text="SISTEMA" Foreground="#00d4ff" FontFamily="Consolas" FontSize="14" FontWeight="Bold" Margin="0,0,0,10"/>
                            <Border Background="#1a1a2e" CornerRadius="6" Padding="15" Margin="0,0,0,15">
                                <StackPanel>
                                    <CheckBox x:Name="chkTemp"  Content="Limpar arquivos temporarios" Style="{StaticResource SupremeCheck}" IsChecked="True"/>
                                    <CheckBox x:Name="chkAnim"  Content="Desativar animacoes do Windows" Style="{StaticResource SupremeCheck}" IsChecked="True"/>
                            ...
                            <TextBlock Text="SERVICOS" Foreground="#00d4ff" FontFamily="Consolas" FontSize="14" FontWeight="Bold" Margin="0,0,0,10"/>
                            <Border Background="#1a1a2e" CornerRadius="6" Padding="15" Margin="0,0,0,15">
                                <StackPanel>
                            ...
                            <TextBlock Text="REDE" Foreground="#00d4ff" FontFamily="Consolas" FontSize="14" FontWeight="Bold" Margin="0,0,0,10"/>
                            <Border Background="#1a1a2e" CornerRadius="6" Padding="15" Margin="0,0,0,15">
                                <StackPanel>
                                    <CheckBox x:Name="chkTCP" Content="Otimizar TCP/IP" Style="{StaticResource SupremeCheck}" IsChecked="True"/>
                                    <CheckBox x:Name="chkDNS" Content="DNS Cloudflare (1.1.1.1) - Mais rapido" Style="{StaticResource SupremeCheck}"/>
                                </StackPanel>
                            </Border>
                            <TextBlock Text="GPU / AVANCADO" Foreground="#00d4ff" FontFamily="Consolas" FontSize="14" FontWeight="Bold" Margin="0,0,0,10"/>
                            <Border Background="#1a1a2e" CornerRadius="6" Padding="15" Margin="0,0,0,15">
                                <StackPanel>
                            ...
                            <Button x:Name="BtnOtimizar" Content="APLICAR OTIMIZACOES"
                                    Style="{StaticResource SupremeBtn}" Height="45" FontSize="15" FontWeight="Bold" Margin="0,10,0,0"/>
                        </StackPanel>
                    </ScrollViewer>
                </TabItem>
                <TabItem Header="Log">
                    <Grid Background="#0d0d0d" Margin="10">
                        <TextBox x:Name="LogBox" Background="#0d0d0d" Foreground="#00ff88"
                                 FontFamily="Consolas" FontSize="12" IsReadOnly="True"
                                 TextWrapping="Wrap" VerticalScrollBarVisibility="Auto"
                                 BorderBrush="#333333" BorderThickness="1" Padding="10" AcceptsReturn="True"/>
                    </Grid>
                </TabItem>
                <TabItem Header="Sobre">
                    <StackPanel VerticalAlignment="Center" HorizontalAlignment="Center" Margin="40">
                        ...
                        <TextBlock Text="Versao 1.0" Foreground="#666666" FontFamily="Consolas" HorizontalAlignment="Center" Margin="0,0,0,30"/>
                        <TextBlock TextWrapping="Wrap" TextAlignment="Center" Foreground="#aaaaaa"
                                   FontFamily="Consolas" FontSize="12" Margin="0,0,0,20"
                                   Text="Ferramenta profissional de otimizacao para Windows."/>
                        <TextBlock Text="supreme-optimization.netlify.app" Foreground="#00d4ff" FontFamily="Consolas" HorizontalAlignment="Center" FontSize="13"/>
                        <TextBlock Text="Discord: discord.gg/eHGuVYqgw4" Foreground="#666666" FontFamily="Consolas" HorizontalAlignment="Center" Margin="0,5,0,0"/>
                    </StackPanel>
                </TabItem>
            </TabControl>
        </Grid>
        ...
        <Border Grid.Row="2" Background="#1a1a2e" BorderBrush="#00d4ff" BorderThickness="0,1,0,0">
            <TextBlock x:Name="FooterMsg" Text="Supreme Optimization - Aguardando autenticacao..."
...
$BtnValidar.Add_Click({
    ...
    if (-not $found) {
        $StatusMsg.Text = "Key invalida! Verifique e tente novamente."
        $StatusMsg.Foreground = "#ff4444"
        $BtnValidar.IsEnabled = $true
        return
    }
    ...
    if ($found.usada -eq $true) {
        $StatusMsg.Text = "Essa key ja foi utilizada!"
        $StatusMsg.Foreground = "#ff4444"
        $BtnValidar.IsEnabled = $true
        return
    }
...
$BtnOtimizar.Add_Click({
    ...
    Add-Log "Iniciando otimizacoes..."
    if ($chkTemp.IsChecked)    { Remove-Item "$env:TEMP\*" -Recurse -Force -ErrorAction SilentlyContinue; Remove-Item "C:\Windows\Temp\*" -Recurse -Force -ErrorAction SilentlyContinue; Add-Log "[OK] Temporarios removidos" }
    if ($chkAnim.IsChecked)    { Set-ItemProperty -Path "HKCU:\Control Panel\Desktop\WindowMetrics" -Name "MinAnimate" -Value "0" -ErrorAction SilentlyContinue; Add-Log "[OK] Animacoes desativadas" }
    ...
    Add-Log "Todas as otimizacoes aplicadas com sucesso!"
    $FooterMsg.Text = "Otimizacoes aplicadas com sucesso!"
